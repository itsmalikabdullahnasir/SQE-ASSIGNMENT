...
/**
 * ════════════════════════════════════════════════════════════════
 *  SearchLibraryTest.java  —  Complete MC/DC + All-Paths Suite
 * ════════════════════════════════════════════════════════════════
 *
 *  TOTAL TEST CASES : 37
 *    BinarySearch        : 10  (TC-BS-01 to TC-BS-10)
 *    LinearSearch        :  8  (TC-LS-01 to TC-LS-08)
 *    InterpolationSearch : 10  (TC-IS-01 to TC-IS-10)
 *    SearchOrder (MC/DC) :  9  (TC-SO-01 to TC-SO-09)
 *
 * ────────────────────────────────────────────────────────────────
 *  MC/DC ANALYSIS  —  SearchOrder.execute()
 * ────────────────────────────────────────────────────────────────
 *
 *  Conditions:
 ...
 *
 *  Independence table  (T = true, F = false, – = don't care):
 *
 *  ┌─────────┬────┬────┬────┬────┬──────────────────────────────┐
 *  │  Test   │ C1 │ C2 │ C3 │ C4 │ Outcome                      │
 *  ├─────────┼────┼────┼────┼────┼──────────────────────────────┤
 *  │TC-SO-01 │ T  │ –  │ –  │ –  │ return -1 (C1 alone decides) │
 *  │TC-SO-02 │ F  │ T  │ F  │ F  │ BinarySearch executes        │
 *  │TC-SO-04 │ F  │ F  │ T  │ F  │ LinearSearch executes        │
 *  │TC-SO-06 │ F  │ F  │ F  │ T  │ InterpolationSearch executes │
 *  └─────────┴────┴────┴────┴────┴──────────────────────────────┘
 *
 * ────────────────────────────────────────────────────────────────
 *  ALL-PATHS COVERAGE  —  SearchOrder.execute() CFG
 * ────────────────────────────────────────────────────────────────
 *
 *  Path  Node sequence               Description
 *  P1    N1→N2→N3→N11                Empty array → -1
 *  P2    N1→N2→N4→N5→N11             BINARY algorithm
 *  P3    N1→N2→N4→N6→N7→N11          LINEAR algorithm
 *  P4    N1→N2→N4→N6→N8→N9→N11       INTERPOLATION algorithm
 *  P5    N1→N2→N4→N6→N8→N10→N11      Unknown (enum prevents this)
 * ────────────────────────────────────────────────────────────────
 */
class SearchLibraryTest {
    ...
    //    Hit at mid    : arr[mid] == target on first probe
    //    Right-half    : arr[mid] < target → low moves up
    //    Left-half     : arr[mid] > target → high moves down
    //    Not found     : search space exhausted → return -1
    // ════════════════════════════════════════════════════════════════
    @Nested
